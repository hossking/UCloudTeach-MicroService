...
public class LiveContent implements Serializable {
    private static final Long serialVersionUID = 67532201340456061L;
    ...
    public LiveContent(Long id, Long liveId, String name, Integer sort, String backVideo, Integer liveTime, Date beginTime, Date beginDate, Boolean status) {
        this.id = id;
        this.liveId = liveId;
        this.name = name;
        this.sort = sort;
